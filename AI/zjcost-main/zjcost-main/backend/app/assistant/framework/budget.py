...
Each handler run gets a budget; when exceeded, the handler is forced
...
@dataclass
class TokenBudget:
    """Token and turn budget for a single handler run.
    ...
    def should_force_answer(self) -> bool:
        """True when the handler should stop calling tools and give a final answer."""
