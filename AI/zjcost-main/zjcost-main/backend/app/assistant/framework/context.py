"""HandlerContext — runtime context injection for tools and agents.

Inspired by standard ToolUseContext pattern. All runtime dependencies
...
Usage:
    ctx = HandlerContext(db=db, project_id=1)
...
if TYPE_CHECKING:
    ...
    from app.assistant.framework.context_store import ContextStore


@dataclass
class HandlerContext:
    """Runtime context injected into every tool and handler.
