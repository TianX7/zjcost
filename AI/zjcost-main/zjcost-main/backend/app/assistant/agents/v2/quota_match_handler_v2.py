"""QuotaMatchHandlerV2 — quota reranking with tool-calling capability.

Upgrades the original single-call quota_match_handler to a tool-calling handler
...
class QuotaMatchHandlerV2(BaseHandler):
    """Quota matching/reranking handler — finds best quota for a BOQ item."""

    @property
    def name(self) -> str:
        return "quota_match_handler"

    @property
    def description(self) -> str:
        return "定额匹配 Handler：为清单项搜索和排序最佳候选定额，给出匹配理由和置信度"
