"""BoqHandlerV2 — BOQ generation with tool-calling capability.

Upgrades the original single-call boq_handler to a tool-calling handler
...
class BoqHandlerV2(BaseHandler):
    """BOQ generation handler with tool-calling for standard code lookup."""
    ...
    def description(self) -> str:
        return "清单生成 Handler：根据工程描述生成工程量清单项，支持GB50500和HKSMM4标准"
    ...
    def system_prompt(self) -> str:
        return """\
你是一位专业的工程量清单编制辅助助手，精通GB50500工程量清单计价规范和HKSMM4标准。
