"""CostValidationHandler — adversarial verification handler (Phase G3).
...
class CostValidationHandler(BaseHandler):
    """Adversarial verification handler — actively tries to find pricing flaws."""
    ...
    def description(self) -> str:
        return "对抗性审核 Handler：以找出问题为目标，审核绑定合理性、单价异常、漏项和合规性"
