"""InsightHandlerV2 — contextual analysis with tool-calling capability.

Upgrades the original single-call insight_handler to a tool-calling handler
...
class InsightHandlerV2(BaseHandler):
    """Contextual analysis handler — provides data-driven insights."""

    @property
    def name(self) -> str:
        return "insight_handler"

    @property
    def description(self) -> str:
        return "分析洞察 Handler：根据项目数据生成专业的造价分析、异常检测和改进建议"
    ...
    def system_prompt(self) -> str:
        return """\
你是工程计价辅助分析助手。根据项目数据，提供专业的造价分析和洞察。
