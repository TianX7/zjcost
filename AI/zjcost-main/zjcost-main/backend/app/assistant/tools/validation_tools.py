...
def check_code_compliance(ctx: HandlerContext, *, boq_code: str, boq_unit: str = "") -> str:
...
def detect_price_anomaly(ctx: HandlerContext, *, boq_item_id: int) -> str:
...
def run_full_validation(ctx: HandlerContext, *, project_id: int) -> str:
...
def get_resource_details(ctx: HandlerContext, *, quota_item_id: int) -> str:
