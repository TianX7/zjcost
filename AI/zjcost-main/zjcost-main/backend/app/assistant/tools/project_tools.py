...
These tools enable the ProjectSetupHandler and FullPipelineHandler to
...
def batch_calculate_project(ctx: HandlerContext) -> str:
...
def recalculate_dirty(ctx: HandlerContext) -> str:
    from app.services.project_calc_service import run_project_calculation
