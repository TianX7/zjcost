...
REST endpoints for direct CRUD + search over HandlerMemory entries. Lets the
...
class MemoryOut(BaseModel):
    """Response model matching HandlerMemory.to_dict() output."""
...
def _store(db: Session):
    ...
    return SQLAlchemyContextStore(db)
