"""辅助-powered BOQ item generation based on project description keywords.
...
_MEP_ITEMS: list[dict] = [
    ...
    {"code": "040103", "name": "阀门安装", "unit": "个", "qty": 30, "division": "安装工程",
     "characteristics": "1.阀门类型：闸阀/截止阀/止回阀\n2.规格：DN20~DN100\n3.连接方式：丝接/法兰/沟槽"},
    {"code": "040104", "name": "卫生洁具安装", "unit": "套", "qty": 24, "division": "安装工程",
     "characteristics": "1.洁具类型：坐便器、洗脸盆、地漏等\n2.安装方式：按设计\n3.含附件安装"},
    {"code": "040201", "name": "电气配管布线", "unit": "m", "qty": 500, "division": "安装工程",
     "characteristics": "1.配管：PVC线管\n2.导线：BV铜芯线\n3.敷设方式：暗敷"},
    {"code": "040204", "name": "电缆电线敷设", "unit": "m", "qty": 450, "division": "安装工程",
     "characteristics": "1.线缆型号：BV/YJV/WDZ-YJY\n2.敷设方式：穿管/桥架\n3.含接线、编号"},
    {"code": "040205", "name": "电缆桥架安装", "unit": "m", "qty": 80, "division": "安装工程",
     "characteristics": "1.桥架材质：钢制喷塑/镀锌\n2.规格：100×50~300×100\n3.安装方式：吊装/支架"},
    ...
    {"code": "040302", "name": "消防设备器具安装", "unit": "个", "qty": 80, "division": "安装工程",
     "characteristics": "1.设备类型：喷头、烟感、温感、报警模块、消火栓箱\n2.安装方式：按设计\n3.含系统调试"},
    {"code": "040401", "name": "通风风管制作安装", "unit": "m²", "qty": 180, "division": "安装工程",
     "characteristics": "1.风管材质：镀锌钢板\n2.系统：送风/排风/防排烟\n3.规格：按设计"},
    {"code": "040402", "name": "暖通设备安装", "unit": "台", "qty": 12, "division": "安装工程",
     "characteristics": "1.设备类型：风机盘管、空调机组、风机\n2.安装方式：吊装/落地\n3.含单机调试"},
]
...
_KEYWORD_MAP: list[tuple[list[str], list[dict], str]] = [
    ...
    (["安装", "水电", "给排水", "给水", "排水", "电气", "强电", "弱电", "管道", "消防", "喷淋", "暖通", "通风", "空调", "风管", "桥架", "电缆"], _MEP_ITEMS, "安装工程相关"),
    ...
    for templates, reason in matched_templates:
        for t in templates:
            ...
            suggestions.append(BoqSuggestion(
                ...
                division=t["division"],
                reason=f"辅助推荐 ({reason})" + (f" — 按 {floors} 层缩放" if floors > 1 else ""),
