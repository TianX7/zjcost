"""Public cement price adapter backed by 100njz market table."""
...
CEMENT_URL = "https://www.100njz.com/cement/"


class GuangcaiAdapter(BasePriceFetcher):
    source_name = "guangcai"
    display_name = "百年建筑水泥行情"

    _supported_categories = ["水泥", "袋装水泥", "散装水泥"]
    ...
    def _fetch_rows(self) -> list[dict[str, str | float]]:
        try:
            ...
            logger.warning("100njz cement fetch failed: %s", exc)
            return []
