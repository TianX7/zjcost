-- Phase H3: Handler Memory system
...
CREATE INDEX IF NOT EXISTS idx_handler_memory_scope
    ON handler_memories (scope, scope_id);
CREATE INDEX IF NOT EXISTS idx_handler_memory_scope_importance
    ON handler_memories (scope, scope_id, importance);
